...
class Pair(Data):
    ...
    @classmethod
    def make_pair(cls, data_source: Data, data_target: Data):
        """
    ...
    def to_data(self) -> Tuple[Data, Data]:
...
class PairBatch(Pair):
    ...
    def from_data_list(data_list):
        r"""
        from a list of torch_points3d.data.pair.Pair objects, create
        a batch
...
class DensePairBatch(Pair):
    ...
    def from_data_list(data_list):
        ...
        if getattr(data_list[0], 'pair_ind', None) is not None:
